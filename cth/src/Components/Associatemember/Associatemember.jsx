...
import Associatememberimage from "../../assets/Associatemember.jpg";
    ...
    <>
        ...
        <section id="h1-breadcrumb">
          <div className="h1-breadcrumb w-full h-fit overflow-hidden relative bg-main-gray pb-16 md:pb-24">
            <div
              ...
              id="win-grid"
            >
              <img src={Associatememberimage} alt="" className=" w-full " />
            </div>
      ...
      <section className="py-[70px] sm:py-[130px] w-full bg-[#E7DDCD]">
        <div className="theme-container w-full mx-auto">
          <h1 className="px-5 bg-buisness-red border border-orange/20  font-medium rounded-[30px] w-fit mx-auto">
            Video Testimonials
          </h1>
