        ...
        <div className="theme-container w-full mx-auto">
          <div className="grid grid-cols-8 lg:grid-cols-12 gap-[30px]">
            <div data-aos="fade-up" className="col-span-8">
              <h1 className="font-semibold text-[40px] leading-[42px] text-main-black">
                Blog Section
              </h1>
              ...
              <div className="grid grid-cols-4 md:grid-cols-8 gap-x-[7px] ">
                <div className="col-span-4  pb-10 border  rounded-md bg-[#A3896B] text-white ">
                        ...
                        <div className="grid md:grid-cols-3 gap-4">
                          <div className="flex">
                            ...
                            <div className="ml-4 text-left">
                              <p className="text-sm font-bold ">By admin</p>
                ...
                <div className="col-span-4  mt-4 pb-10 border  rounded-md bg-[#A3896B] text-white ">
                  <div className="card" style={{ width: "18rem;" }}>
                    <img
                      src="https://s3-alpha-sig.figma.com/img/2d1a/e845/c6a15d12d219161ca61f47c088f07e48?Expires=1720396800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=EdVsn~-l0s2gSe93Q6rmZDS-QsAuiOAWMeN4pTUQX~oWzyzOIdbYV3UKl60rm1XwFKQ4eNWHczOIzh9BcbEG1yhuGjcA6ZytXmig9-epVo80hjSYj~D95Z0a0zcYu8FwkWEaDhq4s5927g77CGuiD~krtdYBIDu6XVNtheULbKNb8CTsUeR7IcJ6ecKNOt0DU-GBrHFr0c~bXR4m088gL578wYOsCfeOhZBA~XLMYCEMs3nUgIuWhUI2HzpfAGubCj4sGseoyN70fw5iJ71wDU--iHphk~J3xkeZE9FYqNLV~I0rY7a1VyfrJTlyh~F245iE~5HMpUq4ZE5WnraWEQ__"
                      className="card-img-top p-4  "
