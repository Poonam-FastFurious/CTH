          ...
          <div className="grid grid-cols-8 lg:grid-cols-12 gap-[30px]">
            <div data-aos="fade-up" className="col-span-8">
              ...
              <div className="grid grid-cols-4 md:grid-cols-8 gap-x-[75px] ">
                <div className="col-span-4  pb-10 border  ">
                  <div className="card" style={{ width: "18rem;" }}>
                    <img
                      src="https://s3-alpha-sig.figma.com/img/2d1a/e845/c6a15d12d219161ca61f47c088f07e48?Expires=1720396800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=EdVsn~-l0s2gSe93Q6rmZDS-QsAuiOAWMeN4pTUQX~oWzyzOIdbYV3UKl60rm1XwFKQ4eNWHczOIzh9BcbEG1yhuGjcA6ZytXmig9-epVo80hjSYj~D95Z0a0zcYu8FwkWEaDhq4s5927g77CGuiD~krtdYBIDu6XVNtheULbKNb8CTsUeR7IcJ6ecKNOt0DU-GBrHFr0c~bXR4m088gL578wYOsCfeOhZBA~XLMYCEMs3nUgIuWhUI2HzpfAGubCj4sGseoyN70fw5iJ71wDU--iHphk~J3xkeZE9FYqNLV~I0rY7a1VyfrJTlyh~F245iE~5HMpUq4ZE5WnraWEQ__"
                      className="card-img-top p-4  "
                      alt="..."
                    />
                    <div className="card-body px-4 pt-4 ">
                      <h5 className="card-title px-4 font-bold">Blog title</h5>
                ...
                <div className="col-span-4  border pb-10">
                  <div className="card" style={{ width: "18rem;" }}>
                    <img
                      src="https://s3-alpha-sig.figma.com/img/2d1a/e845/c6a15d12d219161ca61f47c088f07e48?Expires=1720396800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=EdVsn~-l0s2gSe93Q6rmZDS-QsAuiOAWMeN4pTUQX~oWzyzOIdbYV3UKl60rm1XwFKQ4eNWHczOIzh9BcbEG1yhuGjcA6ZytXmig9-epVo80hjSYj~D95Z0a0zcYu8FwkWEaDhq4s5927g77CGuiD~krtdYBIDu6XVNtheULbKNb8CTsUeR7IcJ6ecKNOt0DU-GBrHFr0c~bXR4m088gL578wYOsCfeOhZBA~XLMYCEMs3nUgIuWhUI2HzpfAGubCj4sGseoyN70fw5iJ71wDU--iHphk~J3xkeZE9FYqNLV~I0rY7a1VyfrJTlyh~F245iE~5HMpUq4ZE5WnraWEQ__"
                      className="card-img-top p-4"
                ...
                <div className="col-span-4 mt-4  border pb-10">
                  <div className="card" style={{ width: "18rem;" }}>
                    <img
                      src="https://s3-alpha-sig.figma.com/img/2d1a/e845/c6a15d12d219161ca61f47c088f07e48?Expires=1720396800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=EdVsn~-l0s2gSe93Q6rmZDS-QsAuiOAWMeN4pTUQX~oWzyzOIdbYV3UKl60rm1XwFKQ4eNWHczOIzh9BcbEG1yhuGjcA6ZytXmig9-epVo80hjSYj~D95Z0a0zcYu8FwkWEaDhq4s5927g77CGuiD~krtdYBIDu6XVNtheULbKNb8CTsUeR7IcJ6ecKNOt0DU-GBrHFr0c~bXR4m088gL578wYOsCfeOhZBA~XLMYCEMs3nUgIuWhUI2HzpfAGubCj4sGseoyN70fw5iJ71wDU--iHphk~J3xkeZE9FYqNLV~I0rY7a1VyfrJTlyh~F245iE~5HMpUq4ZE5WnraWEQ__"
                      className="card-img-top p-4"
              ...
              <img
                className="mt-10"
                src="https://quomodothemes.website/html/quland-html/assets/images/service/detail-2.webp"
                alt=""
              />
              ...
              <p className="text-paragraph mt-5">
                ...
                Molestiae explicabo tempora ipsa dicta distinctio. Lorem ipsum
                dolor sit amet consectetur adipisicing elit. Ipsa quas facere
                laborum soluta expedita! Lorem ipsum dolor, sit amet consectetur
                adipisicing elit. Tenetur aspernatur repellendus sit velit sint?
              </p>
            </div>
            <div
              data-aos="fade-up"
            ...
            >
              <div className="border border-purple/10 rounded-2xl py-[30px] bg-main-gray">
                <div className="flex gap-5 items-center px-10 pb-[30px]">
                  ...
                  <h1 className="text-22 font-semibold text-main-black">
                    Add section
                  </h1>
                </div>
                <hr className="bg-purple/10" />
                <div
                  className="pt-10 flex flex-col px-10 gap-[30px]"
              ...
              <div className="border border-purple/10 rounded-2xl py-[30px] bg-main-gray mt-[30px]">
                ...
                >
                  ...
                  ></textarea>
                  <a href="#">
                    <div className="home-two-btn-bg py-3 group bg-purple border-purple inline-flex">
                      <span className="text-base text-white group-hover:text-purple transition-all duration-300 font-inter relative z-10">
                        Get A Quote
                      </span>
                      <svg
              ...
              <div className="mt-[30px] flex justify-center items-end relative w-full rounded-2xl overflow-hidden">
                ...
                <div className="w-full max-w-[277px] absolute bottom-[30px]">
                  <h1 className="text-24 font-semibold text-white text-center mb-5">
                    Lorem ipsum dolor sit.
                  </h1>
                  <a href="#">
