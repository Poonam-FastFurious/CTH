          ...
          <div className="flex flex-col justify-center  sm:h-auto p-4">
            <div className="max-w-md w-full mx-auto border border-gray-300 rounded-2xl p-8 shadow-xl">
              <form className="max-w-xl w-full p-6 mx-auto">
                ...
                <div>
                  <label className="text-gray-800 text-sm block mb-2  tracking-[0.9px]">
                    Email/Mobile
                  </label>
                ...
                <div className="mt-12">
                  <button
                    type="button"
                    className="w-full py-2.5 px-4 text-sm tracking-wide rounded-md text-white bg-[#B08D57] focus:outline-none"
                  >
                    Sign in
                  </button>
                </div>
