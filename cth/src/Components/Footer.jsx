...
//                 <div>
//                   <img src="assets/images/logo-1.webp" alt="logo" />
//                 </div>
//                 <ul className="flex md:gap-14 gap-5 flex-wrap md:items-center">
//                   <li className="text-18 hover:text-purple hover:underline common-transition text-paragraph font-semibold">
//                     <i>
//                       <svg
//                         width="25"
//                         height="23"
...
//               <div className="w-full h-full flex justify-between items-center md:text-base text-xs">
//                 <span className="text-white">
//                   2024 © All rights reserved by <b>Compliances Townhall</b>
//                 </span>
...
//                   </a>
//                 </div>
//                 <ul className="md:space-x-6 items-center md:flex hidden">
//                   <li className="hover:text-purple hover:underline common-transition text-paragraph font-medium">
