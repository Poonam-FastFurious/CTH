        ...
        <div>
          ...
          <div className="p-6 text-center border-b border-gray-100 ">
            ...
            <div className="relative mb-1 dropdown">
              ...
              <ul
                className="absolute z-50 hidden py-2 mt-2 text-left list-none bg-white border rounded shadow-lg left-20 dropdown-menu w-36 top-6 dark:bg-zinc-700 bg-clip-padding border-gray-50 "
                aria-labelledby="dropdownMenuButtonX"
              >
                <li>
                  <a
                    className="block w-full px-4 py-2 text-sm font-normal text-gray-700 bg-transparent dropdown-item whitespace-nowrap hover:bg-gray-100/50 dark:text-gray-100 /80 ltr:text-left rtl:text-right"
                    href="#"
                  >
                    Available
                  </a>
            ...
            <div data-tw-accordion="collapse">
              <div className="text-gray-700 accordion-item">
                <h2>
                  <button
                    type="button"
                    className="flex items-center justify-between w-full px-3 py-2 font-medium text-left border border-gray-100 rounded-t accordion-header group active dark:border-zinc-600  dark:text-gray-50"
                  >
                  ...
                  <div className="p-5">
                    <div>
                      <div className="ltr:float-right rtl:float-left">
                        <button
                          type="button"
                          className="py-1.5 btn bg-slate-100 border-transparent rounded hover:bg-gray-50 transition-all ease-in-out  dark:text-gray-50 dark:hover:bg-zinc-500/50"
                        >
              ...
              <div className="mt-2 text-gray-700 accordion-item">
                <h2>
                  <button
                    type="button"
                    className="flex items-center justify-between w-full px-3 py-2 font-medium text-left border border-gray-100 rounded accordion-header group  dark:text-gray-50 dark:border-zinc-600"
                  >
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="relative flex-shrink-0 dropdown">
                          ...
                          >
                            <li>
                              <a
                                className="block w-full px-5 py-2 text-sm font-normal text-gray-700 bg-transparent dropdown-item whitespace-nowrap hover:bg-gray-100/50 dark:text-gray-100 "
                                href="#"
                              >
                                Everyone
                              </a>
              ...
              <div className="mt-2 text-gray-700 accordion-item">
                <h2>
                  <button
                    type="button"
                    className="flex items-center justify-between w-full px-3 py-2 font-medium text-left border border-gray-100 rounded accordion-header group dark:border-zinc-600  dark:text-gray-50"
                  >
                    <span className="m-0 text-[14px] font-medium">
                      Security
                    </span>
